            ...
            <div class="modal-body">
                <div class="registro1">
                    <div class="tamaño" id="cambio">
                        ...
                        <div class="reg">
                            <div class="form">
                                <form method="post" action="../Plantilla/registrarseBD.jsp">
                                    <ul>
                                        ...
                                        <li><input type="email" id="correoS" name="correoS" required></li>
                                        ...
                                        <li><small><label>Fecha de Nacimiento:</label> </small>
                                        </li>
                                        ...
                                        <li><small><label for="contrasena">Contraseña:</label> </small>
                                        </li>
            ...
            <div class="modal-body">
                <div class="registro1">
                    <div class="tamaño" id="cambio">
                        ...
                        <div class="reg">
                            <div class="form">
                                <form method="post" action="../Plantilla/ValidarSesion.jsp">
                                    <ul>
                                        <li><small><label for="correo">Correo Electrónico:</label> </small></li>
