...
<body>
    ...
    <div class="SDSJMslider">
        <img src="../../Sedes/ImagenesPantallaSedes/Veterinaria1.png" alt=""><!--1600x700 -->
...
<!------------------------------------------------------------------------------------------------------------>
    <div class="SDSJMdatos">
        ...
        <div class="SDSJMGRID2">
            <div class="SDSJMdoctor1"><img src="ImagenesSedeSJM/Doctor-1.gif" alt=""><h1>Alexandra</h1></div>
            <div class="SDSJMdoctor2"><img src="ImagenesSedeSJM/Doctor-2.jpg" alt=""><h1>Javier</h1></div>
            <div class="SDSJMdoctor3"><img src="ImagenesSedeSJM/Doctor-3.jpg" alt=""><h1>Susana</h1></div>
            <div class="SDSJMdoctor4"><img src="ImagenesSedeSJM/Doctor-4.jpg" alt=""><h1>Erick</h1></div>
        </div>
        <h2>¿Qué ofrecemos?</h2>
        <div class="SDSJMGRID3">
            <div class="SDSJMservicio1">
                <div class="SDSJMimagenServicio">
                    <img src="ImagenesSedeSJM/ServicioBaño.jpg" alt="">
                </div>
            ...
            <div class="SDSJMservicio2">
                <div class="SDSJMimagenServicio"><img
                        src="ImagenesSedeSJM/ServicioVacunacion.jpg"
                        alt=""></div>
                        <div class="SDSJMdatoServicio">
                            <h3>Vacunacion</h3>
            ...
            <div class="SDSJMservicio3">
                <div class="SDSJMimagenServicio"><img
                        src="ImagenesSedeSJM/ServicioEsterelizacion.jpg"
                        alt=""></div>
                <div class="SDSJMdatoServicio">
            ...
            <div class="SDSJMservicio4">
                <div class="SDSJMimagenServicio"><img
                        src="ImagenesSedeSJM/ServicioHospitilizacion.jpg"
                        alt=""></div>
                <div class="SDSJMdatoServicio">
            ...
            <div class="SDSJMservicio5">
                <div class="SDSJMimagenServicio"><img
                        src="ImagenesSedeSJM/ServicioDelibery.jpg"
                        alt=""></div>
                <div class="SDSJMdatoServicio">
                    <h3>Delivery</h3>
            ...
            <div class="SDSJMservicio6">
                <div class="SDSJMimagenServicio">
                    <img src="ImagenesSedeSJM/ServicioLabClinico.jpg"
                        alt="">
                </div>
                <div class="SDSJMdatoServicio">
