<%-- 
    Document   : compras
    Created on : 30/08/2023, 03:20:54 PM
    Author     : andre
--%>
                    ...
                    <div class="col-md-5 col-lg-4 order-md-last">
                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    <h6 class="my-0">${car.getNombres()}</h6>
                                    <small class="text-muted"><img src="ControladorIMG?id=${car.getIdProducto()}" width="50" height="50"></small>
                                </div>
                                <span class="text-muted">S/. ${car.getSubTotal()}</span>
                            </li>
                            </c:forEach>
                            
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Total (USD)</span>
                                <strong>S/.${totalPagar}</strong>
                            </li>
                        </ul>
